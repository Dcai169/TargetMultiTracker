...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__normalize_input = self.blur_output
        self.__normalize_type = cv2.NORM_MINMAX
        self.__normalize_alpha = 1.0
        self.__normalize_beta = 150.0

        self.normalize_output = None

        self.__hsv_threshold_input = self.normalize_output
        # Vision Tape 3
        # self.__hsv_threshold_hue = [0.0, 90.0]
        # self.__hsv_threshold_saturation = [0.0, 100.0]
        # self.__hsv_threshold_value = [150.0, 255.0]
        # Vision Tape 2
        self.__hsv_threshold_hue = [75.0, 180.0]
        self.__hsv_threshold_saturation = [0.0, 255.0]
        self.__hsv_threshold_value = [140.0, 255.0]
        # Vision Tape
        # self.__hsv_threshold_hue = [0.0, 95.0]
        # self.__hsv_threshold_saturation = [0.0, 255.0]
        # self.__hsv_threshold_value = [145.0, 255.0]
        # Yellow Sticky
        # self.__hsv_threshold_hue = [20.0, 50.0]
        # self.__hsv_threshold_saturation = [135.0, 240.0]
        # self.__hsv_threshold_value = [120.0, 255.0]
        # Blue Tape
        # self.__hsv_threshold_hue = [35.0, 155.0]
        # self.__hsv_threshold_saturation = [80.0, 200.0]
        # self.__hsv_threshold_value = [105.0, 250.0]
        ...
        self.__cv_canny_image = self.cv_erode_output
    ...
    def process(self, source0):
        ...
        # self.resize_image_output = source0

        # Step Normalize0:
        self.__normalize_input = self.resize_image_output
        ...
        # (self.cv_erode_output) = self.__cv_dilate_src
    ...
    def __find_contours(input, external_only):
        ...
        _, contours, _ = cv2.findContours(input, mode=cv2.RETR_EXTERNAL, method=cv2.CHAIN_APPROX_SIMPLE)
        return contours
